    ...
    <footer className="bg-base-100 text-gray-300 p-10 border-t border-gray-700">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          />
          <div>
            <h2 className="text-2xl font-semibold text-[#fbd54e]">ShlokVaani</h2>
            <p className="text-sm text-gray-400">Exploring the wisdom of ancient scriptures</p>
          </div>
        </div>
        ...
        <div className="mt-6 md:mt-0">
          ...
          <div className="flex space-x-4 mt-2">
            <a href="#" className="hover:text-[#fbd54e] transition">
              <svg
